...
String parameterToString(dynamic value) {
  ...
  if (value is PointReason) {
    return PointReasonTypeTransformer().encode(value).toString();
  }
  if (value is RequisitionStatus) {
    return RequisitionStatusTypeTransformer().encode(value).toString();
  }
  if (value is TrueFalseNotGivenEnum) {
    return TrueFalseNotGivenEnumTypeTransformer().encode(value).toString();
  }
